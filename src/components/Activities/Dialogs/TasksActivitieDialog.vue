...
const nameModule = ref(
  props.module == 'Leads'
    ? 'Leads'
    : props.module == 'Opportunities'
    ? 'OPPORTUNITIES'
    : props.module == 'HANO_Lead'
    ? 'HANOLEAD'
    : props.module
);
...
const optionTypeTask = computed(() => {
  return (
    formStore?.tasksOptions?.typesTask.filter(
      (o: any) =>
        o.module == nameModule.value && o.iddivision == userCRM.iddivision
    ) || []
  );
});
...
<template>
  ...
  >
            ...
            <q-item>
              ...
              <q-item-section>
                <q-item-label class="text-white text-h5"
                  >Nueva Tarea</q-item-label
                >

                <q-item-label class="text-grey-4 text-caption" lines="1"
                  >Programe una nueva tarea de manera sencilla
                </q-item-label>
              </q-item-section>
            </q-item>
          </q-list>
              ...
              <q-form ref="myForm" v-model="localTask">
                <q-card-section>
                  ...
                  <div class="col q-gutter-y-md">
                    <q-select
                      v-model="localTask.attributes.tipotarea_c"
                    ...
                    <q-input
                      ...
                      borderless
                      dense
                      v-model="localTask.attributes.name"
                      type="text"
                      label="Asunto*"
                    >
                      <template #before>
                    ...
                    <q-input
                      style="width: 100%"
                      v-model="localTask.attributes.description"
                      type="textarea"
                      label="Descripcion"
                      outlined
                    >
                    ...
                    <q-select
                      v-model="localTask.attributes.status"
    ...
    <template #footer>
      <q-btn color="primary" class="q-mr-md" @click="validateForm"
        >Guardar</q-btn
      >
