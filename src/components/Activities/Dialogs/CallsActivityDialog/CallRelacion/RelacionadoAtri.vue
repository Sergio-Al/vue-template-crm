          ...
          <Transition enter-active-class="animated lightSpeedInRight">
            <div class="col-md-6 col-sm-12" v-if="isFiltering">
              <q-card class="no-border-radius bg-none" flat>
                <q-card-section>
                  <div class="text-h7 q-mb-sm">Lista de Atributos</div>
                      ...
                      >
                        ...
                        >
                          ...
                          <q-item-section>
                            ...
                            <span class="text-blue">Atributo</span>
                          </q-item-section>
                        </q-item>
                      </q-virtual-scroll>
                    </q-list>
...
<script lang="ts">
export default {
  name: 'RelacionadoAtri',
};
</script>
<script setup lang="ts">
import { computed } from 'vue';
import { useBusquedaAtri } from '../../../../../composables/Activity/useBusquedaAtri';
