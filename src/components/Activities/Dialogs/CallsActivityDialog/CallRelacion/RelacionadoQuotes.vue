<template>
                        ...
                        <q-item :key="index">
                          ...
                          >
                            ...
                            <q-item-label caption lines="1"
                              ><span class="text-primary">División: </span
                              >{{ item.name_iddivision_c }}
                            </q-item-label>
  ...
  <GeneralDialog ref="generalDialogRef" />
</template>
<script lang="ts">
export default {
  name: 'RelacionadoQuotes',
};
</script>
<script setup lang="ts">
import { ref, computed } from 'vue';
import { useBusquedaQuotes } from '../../../../../composables/Activity/useBusquedaQuotes';
...
const verDialogItem = async (id: string) => {
  await generalDialogRef.value?.openDialogQuotesTab(id);
};
