          ...
          <Transition enter-active-class="animated lightSpeedInRight">
            <div class="col-md-6 col-sm-12" v-if="isFiltering">
              <q-card class="no-border-radius bg-none" flat>
                <q-card-section>
                  <div class="text-h7 q-mb-sm">Lista de Proveedores</div>
                      ...
                      >
                        ...
                        >
                          ...
                          <q-item-section>
                            ...
                            <span class="text-blue">Proveedor</span>
                          </q-item-section>
                        </q-item>
                      </q-virtual-scroll>
                    </q-list>
...
<script lang="ts">
export default {
  name: 'RelacionadoProveedor',
};
</script>
<script setup lang="ts">
import { computed } from 'vue';
// import { useBusquedaPro } from '../../../../../composables/Activity/useBusquedaPro';
import { useBusquedaProveedores } from '../../../../../composables/Activity/useBusquedaProveedores';
