...
import { useInputDirection } from '../../composables/Inputs/InputDirection';
import { MapComponentLeaflet } from 'src/components/MapsGPS/index';
import { OpenStreetMapProvider } from 'leaflet-geosearch';
import { DirectionComponentModel } from '../types';
...
const props = defineProps<{
  modelValue: DirectionComponentModel;
  options: DirectionValueModel[];
}>();
const emits = defineEmits<{
  (event: 'update:modelValue', values: DirectionComponentModel): void;
}>();
const sendValueToParent = (value: DirectionComponentModel) => {
...
const newDirection = (val: string) => {
  console.log(val);
  sendValueToParent({
    address_street_generated_c: val,
