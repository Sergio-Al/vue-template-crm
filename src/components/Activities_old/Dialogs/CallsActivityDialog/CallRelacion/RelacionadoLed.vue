          ...
          <Transition enter-active-class="animated lightSpeedInRight">
            <div class="col-md-6 col-sm-12" v-if="isFiltering">
              <q-card class="no-border-radius bg-none" flat>
                <q-card-section>
                  <div
                    class="text-h6 q-mb-sm flex flex-center text-light-blue-10"
                  >
                    Lista de leads
                  </div>
                      ...
                      >
                        <q-item :key="index">
                          ...
                          >
                            ...
                            <span class="text-light-blue-10">Lead</span>
                          </q-item-section>
                          <q-item-section>
                            <q-btn
                              outline
...
// import spanish from '../../../../../boot/dateLanguage';
import { useBusquedaLed } from '../../../../../composables/Activity/useBusquedaLed';
