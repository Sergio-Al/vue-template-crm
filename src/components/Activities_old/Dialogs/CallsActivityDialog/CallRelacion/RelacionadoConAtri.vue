              ...
              <q-card class="no-border-radius bg-none" flat>
                <q-card-section>
                  <div class="text-h7 q-mb-sm">
                    Lista de Conjunto de Atributos
                  </div>
                      ...
                      >
                        ...
                        >
                          ...
                          <q-item-section>
                            ...
                            <span class="text-blue">Conjunto Atributo</span>
                          </q-item-section>
                        </q-item>
                      </q-virtual-scroll>
                    </q-list>
          ...
          >
            <q-card class="no-border-radius" flat bordered>
              <q-card-section class="row q-col-gutter-sm">
                <span>Conjunto de Atributos</span>
...
<script lang="ts">
export default {
  name: 'RelacionadoConAtri',
};
</script>
<script setup lang="ts">
import { computed } from 'vue';
import { useBusquedaConAtri } from '../../../../../composables/Activity/useBusquedaConAtri';
