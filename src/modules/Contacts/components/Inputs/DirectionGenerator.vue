...
import { DirectionContactComponentModel } from '../../utils/types/index';
...
const props = defineProps<{
  modelValue: DirectionContactComponentModel;
  options: DirectionValueModel[];
}>();
const emits = defineEmits<{
  (event: 'update:modelValue', values: DirectionContactComponentModel): void;
}>();
const sendValueToParent = (value: DirectionContactComponentModel) => {
...
<template>
  ...
  <div v-else>
    ...
    >
      <template #append>
        <q-btn class="gt-xs" size="12px" flat dense round icon="place">
