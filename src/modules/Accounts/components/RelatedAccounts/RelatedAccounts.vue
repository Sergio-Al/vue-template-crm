  ...
  >
    ...
    <q-card-section class="q-px-none">
        ...
        >
          ...
          >
            ...
            >
              ...
              <q-item-section side v-if="contact.parent_id">
                <div>
              ...
              <q-item-section side tyle="max-width: 150px">
                <q-btn
                  color="positive"
                  icon="person_add"
                  :label="$q.screen.xs ? '' : 'Seleccionar'"
                  class="q-px-sm"
                  rounded
                  size="sm"
                  dense
      ...
      <span v-if="totalSelected === 0 && !edit">
        ...
        <a @click="editList" class="cursor-pointer text-blue"> Agregar</a>
      </span>
    </q-card-section>
  </q-card>
...
import {
  useRelatedAccounts,
  useUtils,
} from '../../composables/useRelatedAccount';
