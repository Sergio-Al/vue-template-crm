...
export const dataColumnsBigTable = [
  {
    id: 0,
    type: 'checkbox',
    width: '50',
...
export const emailsTemplateData = [
  {
    id: 1,
    division: 'Automotriz',
    modules: 'Todas',
    name: 'Prueba de Template 101',
    type: 'Respuesta y aprobacion',
    description: 'Modelo para buscar una respuesta a la aprobacion',
    createdBy: 'Paulo Ochoa',
    created: '25/08/2021 08:00 pm',
  },
  {
    id: 2,
    division: 'Automotriz',
...
export const emailsTemplateColumns = [
  {
    name: 'div',
    required: true,
    label: 'Division',
    align: 'left',
    style: 'max-width: 60px; white-space: normal',
  ...
  },
  {
    ...
    label: 'Nombre',
    field: (row) => row.name,
    style: 'max-width: 90px; white-space: normal',
    align: 'left',
    sortable: true,
    val: 'name',
  },
  ...
  { name: 'action', label: 'Accion', field: 'action' },
];
...
export const templateDataComplete = [
  {
    id: 12,
    description: 'Modelo para buscar una respuesta a la aprobacion',
    division: 'Automotriz',
