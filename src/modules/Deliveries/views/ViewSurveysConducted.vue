...
<script setup lang="ts">
  ...
  import { useDeliveriesStore } from '../../Deliveries/store/DeliveriesStore';
  import { HANSACRM3_URL } from 'src/conections/api_conectors';
  const { getDeliverySurveysConducted } = useDeliveriesStore();
  ...
  onMounted(async () => {
    documentRelation.value = await getDeliverySurveysConducted(props.id);
