...
<script lang="ts" setup>
  const { getProspectsHistoryChanges,getHistoryInitial } = useProspectStore();
  ...
  onMounted(async () => {
    historyInitiallist.value = await getHistoryInitial(id.value,'Prospects');
    historyChangeslist.value = await getProspectsHistoryChanges(id.value);
  });
</script>
<style scoped>
  #mapid {
