...
import { getActivitiesProyects } from '../../services/useProjectService';
import EmailsActivitieDialog from 'src/components/Activities/Dialogs/EmailsActivitieDialog.vue';
...
import TasksActivitieDialog from 'src/components/Activities/Dialogs/TasksActivitieDialog.vue';
import NoteActivitieDialog from 'src/components/Activities/Dialogs/NoteActivitieDialog.vue';
import AlertComponent from 'src/components/MainAlert/AlertComponent.vue';
import { ModuleActivity } from 'src/components/types/index';
import { moduleKey, idModuleKey } from 'src/components/Activities/ProvideKeys';
...
onMounted(async () => {
  ...
  getActivities.value = await getActivitiesProyects(id.value, dateStart, dateEnd);
...
const cargaData = async () => {
  if (rangeDate.value.from != undefined) {
    ...
    getActivities.value = await getActivitiesProyects(
      id.value,
      dateStart,
      dateEnd
    );
                      ...
                      >
                        ...
                        <q-btn  round color="blue" class="shadow-5" text-color="white" size="md" icon="check"
                          ...
                          >
                            ...
                            <q-item-label
                              v-if="reg.descripcion.length > 200 && reg.descripcion_truncate.length < 200"
                            >
